...
export default function EmailList() {
  ...
  const sendRealtime = async () => {
    ...
    try {
      ...
      if (!res.ok) throw new Error('Failed to send realtime Email');

      setResponse('✅ Realtime Email sent to all users');
    } catch (err) {
      setResponse(`❌ ${err.message}`);
    } finally {
          ...
          {!confirming && !sendingRealtime ? (
            ...
            <div className="text-center space-y-4">
              <div className="font-semibold">
                Send Email to <span className="text-red-600">ALL users</span>?
              </div>
            ...
            <div className="text-center space-y-2">
              ...
              <div className="font-bold text-red-600">Sending Email...</div>
